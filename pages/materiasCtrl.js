app.controller('materiasCtrl', function($scope, ngDialog, $modal, ServicioBackend) {
    
	$scope.objeto = {materia:null, termino:null, detalle:null};
	$scope.filtro = {materia:null, termino:null}
	
	$scope.tiposMateria = [{id:1, descripcion:"Matematica"}, {id:2, descripcion:"Fisica"}, {id:3, descripcion:"IT"}, {id:4, descripcion:"GIT"}];
	$scope.lista = null; //[];
